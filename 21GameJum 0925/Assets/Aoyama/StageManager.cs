...
public class StageManager : MonoBehaviour
{
    ...
    public void StartCreate()
    {
        ...
        mapsObj.Add(Instantiate(maps[1], new Vector2(20, 0), Quaternion.identity));
        mapsObj.Add(Instantiate(maps[2], new Vector2(40, 0), Quaternion.identity));
    }

    public void CreateStage()
    {
        count++;
        int createIndex = count * 20;
